...
const socialConfig: SocialConfigItem[] = [
  ...
  },
  {
    ...
    primary_url: SOCIAL_URLS.substackPublication,
    mode: 'rss',
    rss_url: SOCIAL_URLS.substackFeed,
    hide_empty_latest: true,
    featured: [
      { label: 'RSS feed', url: SOCIAL_URLS.substackFeed }
    ]
  },
  {
    slug: 'spotify',
  ...
  },
  {
    ...
    primary_url: '/archive/music',
    primary_label: 'Browse music archive',
    mode: 'manual',
    featured: [
  ...
  },
  {
    ...
    primary_label: 'Open Discord hub',
    mode: 'manual',
    featured: [
