...
const rooms: Room[] = [
  ...
  },
  {
    ...
    machines: [
      {
        title: 'Discord (server): Neighborhood Corner channel',
        summary: 'Neighborhood Corner inside the shared Discord server.',
        kind: 'external',
        url: 'https://discord.gg/rNjaEQbe'
      },
      {
        title: "Discord (server): Creator's Corner channel",
        summary: "Creator's Corner inside the same Discord server.",
        kind: 'external',
        url: 'https://discord.gg/rNjaEQbe'
      }
    ]
