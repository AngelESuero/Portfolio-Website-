...
const LINK_HUB_CATEGORY_SEEDS: LinkHubCategory[] = [
  {
    ...
    items: [
      ...
      {
        id: 'scraps-2021-2022',
        title: 'Scraps: Adrift Abyss and The Star Shaped Humans (2021–2022)',
        url: MUSIC_URLS.untitledScraps2122,
        year: '2021-2022',
        tag: 'Scraps',
        preferredEmbed: 'untitled'
      },
      {
        id: 'scraps-2022-2023',
        title: 'Scraps: Death Of My Isolation + Some Repeated Lessons (2022–2023)',
        url: MUSIC_URLS.untitledScraps2223,
        year: '2022-2023',
        tag: 'Scraps',
        preferredEmbed: 'untitled'
      },
      {
        id: 'scraps-2023-2024',
        title: 'Scraps: Dark Days, Cultivate, No Context Demos Tapes (2023–2024)',
        url: MUSIC_URLS.untitledScraps2324,
        year: '2023-2024',
        tag: 'Scraps',
        preferredEmbed: 'untitled'
      },
